...
class Test(unittest.TestCase):
    ...
    def test_depth_times_horizontal(self):
        self.assertEqual(solve(self.cmds), 150)

    def test_depth_times_horizontal_with_aim(self):
        self.assertEqual(solve_part_two(self.cmds), 900)
