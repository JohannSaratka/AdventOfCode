...
class Test(unittest.TestCase):
    def testDealIntoNewStack(self):
        self.assertEqual(slamShuffle(list(range(10)),['deal into new stack']), 
                         list(range(10 - 1,-1,-1)))
        
    def testCutPositive(self):
        self.assertEqual(slamShuffle(list(range(10)),['cut 3']), 
                         [3, 4, 5, 6, 7, 8, 9, 0, 1, 2])
        
    def testCutNegative(self):
        self.assertEqual(slamShuffle(list(range(10)),['cut -4']), 
                         [ 6, 7, 8, 9, 0, 1, 2, 3, 4, 5])
        
    def testDealWithIncrement(self):
        self.assertEqual(slamShuffle(list(range(10)),['deal with increment 3']), 
                         [ 0, 7, 4, 1, 8, 5, 2, 9, 6, 3])
        
    def testAll1(self):
        self.assertEqual(slamShuffle(list(range(10)),['deal with increment 7',
                                                      'deal into new stack',
                                                      'deal into new stack']), 
                         [ 0, 3, 6, 9, 2, 5, 8, 1, 4, 7])
    
    def testAll2(self):
        self.assertEqual(slamShuffle(list(range(10)),['cut 6',
                                                      'deal with increment 7',
                                                      'deal into new stack']), 
                         [ 3, 0, 7, 4, 1, 8, 5, 2, 9, 6])
...
def slamShuffle(deck, instructions):    
...
def solve(instructions):
    deck = slamShuffle(list(range(10007)), instructions) 
