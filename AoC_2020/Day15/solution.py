...
the time it was most recently spoken before then (turn 1). Thus, the 5th number
spoken is 4 - 1, 3.
...
class Test(unittest.TestCase):
    def test_elves_memory1(self):
        starting_numbers = "0,3,6"
        self.assertEqual(solve(starting_numbers), 436)

    def test_elves_memory2(self):
        starting_numbers = "1,3,2"
        self.assertEqual(solve(starting_numbers), 1)

    def test_elves_memory3(self):
        starting_numbers = "2,1,3"
        self.assertEqual(solve(starting_numbers), 10)

    def test_elves_memory4(self):
        starting_numbers = "1,2,3"
        self.assertEqual(solve(starting_numbers), 27)

    def test_elves_memory5(self):
        starting_numbers = "2,3,1"
        self.assertEqual(solve(starting_numbers), 78)

    def test_elves_memory6(self):
        starting_numbers = "3,2,1"
        self.assertEqual(solve(starting_numbers), 438)

    def test_elves_memory7(self):
        starting_numbers = "3,1,2"
        self.assertEqual(solve(starting_numbers), 1836)

    def test_elves_memory_part_two1(self):
        starting_numbers = "0,3,6"
        self.assertEqual(solve_part_two(starting_numbers), 175594)

    def test_elves_memory_part_two2(self):
        starting_numbers = "1,3,2"
        self.assertEqual(solve_part_two(starting_numbers), 2578)

    def test_elves_memory_part_two3(self):
        starting_numbers = "2,1,3"
        self.assertEqual(solve_part_two(starting_numbers), 3544142)

    def test_elves_memory_part_two4(self):
        starting_numbers = "1,2,3"
        self.assertEqual(solve_part_two(starting_numbers), 261214)

    def test_elves_memory_part_two5(self):
        starting_numbers = "2,3,1"
        self.assertEqual(solve_part_two(starting_numbers), 6895259)

    def test_elves_memory_part_two6(self):
        starting_numbers = "3,2,1"
        self.assertEqual(solve_part_two(starting_numbers), 18)

    def test_elves_memory_part_two7(self):
        starting_numbers = "3,1,2"
        self.assertEqual(solve_part_two(starting_numbers), 362)


def solve(starting_numbers, end_num=2020):
    numbers = list(map(int, starting_numbers.split(',')))
    lookup = defaultdict(list)
    for num, x in enumerate(numbers):
        lookup[x].extend([num + 1] * 2)
    turn = len(numbers)
    last = numbers[-1]
    while turn < end_num:
        indices = lookup[last]
        last = indices[1] - indices[0]
        turn += 1
        try:
            lookup[last][0] = lookup[last][1]
            lookup[last][1] = turn
        except IndexError:
            lookup[last].extend([turn]*2)
    return last


def solve_part_two(starting_numbers):
    return solve(starting_numbers, 30000000)
...
if __name__ == "__main__":
    with open("input.txt", 'r') as inFile:
        ...
        print("Solution Part 2: {}".format(solve_part_two(puzzleInput[0])))
